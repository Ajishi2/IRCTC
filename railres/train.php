                ...
                <form style="margin:0px;" method="post">
                    <table class="table" style="margin-bottom:0px;">
                        <tr>
                            ...
                            <td style="border-top:0px;"><input class="btn btn-info" background-color: #091b56; type="submit" value="Find"></td>
                            <td style="border-top:0px;"><a href="train.php" class="btn btn-info" background-color: #091b56; type="reset" value="Reset">Reset</a></td>
                        </tr>
                    </table>
                </form>
            </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-6 text-center">
            <div class="span12 well" style="margin-top:60px;">
